...
\begin{figure}[h]
    ...
    \caption{Hướng dẫn sắp xếp dữ liệu theo yêu cầu đặc thù    là  tên và tên đệm}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Hướng dẫn lọc dữ liệu theo   nhiều tiêu chí là sinh tháng 6 và ở HCM}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Hướng dẫn lọc dữ liệu theo yêu cầu đặc thù: control & check}
\end{figure}
